...
<head>	
  <meta charset="utf-8">
  <title>User Login - Barato Supply Compnay</title>
    	...
    	<div class="col-sm-6 col-sm-offset-3">
      		<div class="panel panel-default">
            	...
            	<div class="panel-body">
							...
							<fieldset>
								<div class="form-group">
									<div class="input-group input-group-lg">
										...
										<input class="form-control" type="text" name="p_number" placeholder="Phone Number" required/><br/>	
									</div>
								</div>
								<div class="form-group">
									<div class="input-group input-group-lg">
						...
						<p class="m-b-0 m-t">No account yet?<br/>
						<a href="pages/signup.php" style="color:#3B5998;">Sign Up</a></p>
						<p class="m-b-0 m-t">Admin?	<br/>
						<a href="./admin_login.php" style="color:#3B5998;">Click Here</a></p>
				</div>
			</div>
		</div>
	</div>
